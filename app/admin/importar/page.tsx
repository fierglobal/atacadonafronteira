  ...
  return (
    <div style={{ padding: 24, maxWidth: 760 }}>
      ...
      <p style={{ color: 'var(--a-text3)', fontSize: 13, marginBottom: 24 }}>
        Faça upload de um arquivo CSV com cabeçalho. Colunas aceitas: name, titulo, descricao, brand, categoria_id, brl_price, brl_price_promo, brl_price_qty, qty_min, custo, img_url, video_url, ativo, sort_order, estoque, sku, peso, largura, altura, comprimento, slug, meta_titulo, meta_descricao.
        Obrigatórias: <strong>name, brl_price</strong>.
      </p>
      ...
      <div style={{ marginTop: 24, padding: 16, background: 'var(--a-surface)', border: '1px solid var(--a-border)', borderRadius: 12 }}>
        ...
        <pre style={{ background: 'var(--a-bg)', padding: 12, borderRadius: 8, fontSize: 11, overflow: 'auto' }}>{`name,brand,brl_price,estoque,ativo,sku
"Maca Peruana 60 caps","Atacado na Fronteira",82.15,100,true,MAC60
"Whey Isolate 1kg","Atacado na Fronteira",222.60,50,true,WHY1K`}</pre>
      </div>
    </div>
  )
}
